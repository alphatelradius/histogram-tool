...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <title>Add New Automation (Manual Mode) Process - Histogram Automation Tool</title>
            ...
            <div class="content">
                ...
                <div class="content-container">
                    ...
                    <div class="content-header">
                        <h2 class="content-headeindex-2.htmlr-title">Automation Process (Manual Mode)</h2>
                        <ol class="breadcrumb">
                            ...
                            <div class="portlet">
                                ...
                                <div class="portlet-header">
                                    ...
                                    <h3>
                                        ...
                                        Add New Process Bellow (Manual Mode)
                                    </h3>
                                ...
                                <div class="portlet-content">
                                    ...
                                    {{ Session::get('message') }}
                                    @endif
                                    {{ Form::open(array('url' => 'manual/save','method'=>'POST','id'=>'validate-basic','class'=>"form parsley-form")) }}
                                    ...
                                    <div class="form-group col-md-8" >
                                     ...
                                     <div class="form-group col-md-8" >
                                        <label for="name">Amount of charts</label>
