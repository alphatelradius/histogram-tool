...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
         <title>Technology - Histogram Automation Tool</title>
                ...
                <div class="content-container">
                    ...
                    <div class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Available Technology</li>
                            <li ><a href="{{ URL::to('/technology/add')}}">Add New Technology</a></li>
                        </ol>
                    </div> <!-- /.content-header -->
                                        ...
                                        <table 
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-direction="asc" data-filterable="true" data-sortable="true">Description</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ URL::to('/technology/add')}}/{{ SiteHelpers::encryptID($value->id) }}" class="btn btn-xs btn-info" data-original-title="Approve">
                                                            <i data-toggle="tooltip" data-placement="top" title="edit" data-original-title="" class="fa fa-edit ui-tooltip"></i>
                                                        </a>
                                                        <a href="{{ URL::to('/technology/delete')}}/{{ SiteHelpers::encryptID($value->id) }}" class="btn btn-xs btn-primary" data-original-title="Approve">
