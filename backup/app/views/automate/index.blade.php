...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <title>List of All Complete Process - Histogram Automation Tool</title>
            ...
            <div class="content">
                ...
                <div class="content-container">
                    ...
                    <div class="content-header">
                        <h2 class="content-headeindex-2.htmlr-title">Process</h2>
                        <ol class="breadcrumb">
                            <li><a href="{{ URL::to('')}}">Home</a></li>
                            <li class="active">Complete Process</li>
                            <li ><a href="{{ URL::to('/automate/add')}}">Add New Process</a></li>
                        </ol>
                    </div> <!-- /.content-header -->
                                        ...
                                        <table 
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-direction="asc" data-filterable="true" data-sortable="true">Process Note</th>
                                                    <th data-direction="asc" data-filterable="true" data-sortable="true">Result</th>
                                                    <th data-filterable="false" class="hidden-xs hidden-sm">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($result as $key => $value)
                                                <?php if (file_exists(public_path('presentation/'.$value->file_result.'.pptx'))) {?>
                                                <tr>
                                                    ...
                                                    <td>{{ $value->info }}
                                                    <td>{{ $value->file_result }}  <a href="{{ URL::to('presentation')}}/{{ $value->file_result }}.pptx" class="btn btn-xs btn-success" data-original-title="Download">
                                                            <i data-toggle="tooltip" data-placement="top" title="download" data-original-title="" class="fa fa-download ui-tooltip"></i>
                                                        </a> </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="{{ URL::to('/automate/delete')}}/{{ SiteHelpers::encryptID($value->id) }}" class="btn btn-xs btn-primary" data-original-title="Approve">
